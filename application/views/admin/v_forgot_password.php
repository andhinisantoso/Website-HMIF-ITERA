...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url() ?>assets/favicon.jpg">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="<?= base_url() ?>admin/changepassword">
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <input type="email" class="form-control form-control-user" name="email" placeholder="Email" value="<?= $email; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <input type="text" name="email" value="<?= $hashemail ?>" hidden>
                                        <input type="text" name="tanggal" value="<?= $hashtgl ?>" hidden>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url(); ?>admin/index">Login?</a>
                                    </div>
                                    <div class="text-center">
