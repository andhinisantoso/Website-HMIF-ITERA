...
<div class="upload">
  ...
  <form class="form-horizontal" action="<?php echo base_url(); ?>admin_profile/do_upload_logo" method="post" enctype="multipart/form-data">
  <div class="card-body">
    <input type="file" name="logo" id="input-file-now-custom-1" class="dropify" data-default-file="<?= base_url(); ?>assets/gambar/logo/<?= $data_foto ?>">
  </div>
