...
<html lang="en" >
<head>
  <title>Upload Photo Banner</title>
...
<div class="upload">
  ...
  <form class="form-horizontal" action="<?php echo base_url(); ?>admin_profile/do_upload_banner" method="post" enctype="multipart/form-data">
  <div class="card-body">
    <input type="file" name="banner" id="input-file-now-custom-1" class="dropify" data-default-file="<?= base_url(); ?>assets/gambar/banner/<?= $data_foto ?>">
  </div>
  ...
  <div class="card-footer">
      ...
      Upload</button>
      <a href="<?= base_url(); ?>admin_profile/edit/<?= $id_profil; ?>">
      <button type="button" class="btn btn-danger btn-sm float-right">
        <i class="fa fa-trash">&nbsp
        </i>Cancel
      </button>
    </a>
  </div>
